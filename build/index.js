...
var Clock = function Clock(canvas, size, colors, interval) {
 ...
 */
var PolarClock = function PolarClock(canvas, point, line, margin, color) {
  this.canvas = canvas;
...
PolarClock.prototype.draw = function (index, point, radian) {
  this.point = new Point(point.x, point.y, point.radius - (this.line + this.margin) * index);
 ...
 * time radian
 */
var getTimeRadian = function getTimeRadian() {
  var now = new Date();
...
var PolarClock = function (_React$Component) {
  _inherits(PolarClock, _React$Component);

  function PolarClock() {
    _classCallCheck(this, PolarClock);

    return _possibleConstructorReturn(this, (PolarClock.__proto__ || Object.getPrototypeOf(PolarClock)).apply(this, arguments));
  }

  _createClass(PolarClock, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var colors = _extends({}, defaultColors, this.props.colors);
      this.clock = new _clock2.default(this._canvas, this.props.size / 2, colors, this.props.interval);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement('canvas', { ref: function ref(c) {
        ...
        }, height: this.props.size, width: this.props.size, style: { backgroundColor: this.props.backgroundColor } });
    }
  }]);
